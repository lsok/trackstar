...
class IssueController extends Controller
{
	...
	*/
	...
	{
		//if the project property is null, create if based on input id
	...
	public function filters()
	{
		return array(
			...
			'projectContext + create index update admin', //check to ensure valid project context
		);
	}
	...
	public function actionAdmin()
	{
		...
		$model->project_id=$this->_project->id; //为问题列表限制项目上下文
	...
	* filters() method It is called before the actionCreate() action
	* method is run inorder to ensure a proper project context
	*/
