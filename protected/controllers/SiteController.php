...
{	
	...
	public function actionLogin()
	{
		...
		// 设置页面元标签
		$this->pageTitle_cn='这是登录页的中文title';
		$this->pageDescription_cn='这是登录页的中文description';

		$this->pageTitle_en='this is english page title';
		$this->pageDescription_en='this is english page description';
