 ...
 * the form data related to adding an existing user to a project.
...
class ProjectUserForm extends CFormModel
{
	...
	/**
	 * @var string the role which the user will be associated within
	 * the project
	 */
	public $role;
	 ...
	 * and username needs to be authenticated using the verify() method
	 */
	 ...
	 * If valid, it will make the association between the user,role and project. 
