...
class Project extends TrackStarActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('name, name_cn', 'length', 'max'=>128),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, name, name_cn, description, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	*/
	...
	/**
	* Returns an array of available roles in which a user can be placed when
	...
	*/
	...
	/**
	* Makes an association between a user and a project
	*/
